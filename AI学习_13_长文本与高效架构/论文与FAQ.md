...
> 本文档汇总长文本与高效架构领域的关键论文与延伸资源，供系统性学习和查阅使用。
>
> **内容时效**：截至 2026 年 4 月
...
- **核心贡献**：给 Transformer 增加一份固定大小的“压缩记忆”。当前段内仍用标准注意力处理细节，跨段信息则通过压缩记忆传递；模型再自己学习什么时候看当前窗口、什么时候查历史记忆。
...
- **核心贡献**：说明 SSM、线性注意力和部分注意力形式之间并不是完全割裂的路线，而是存在统一视角；在这个视角下，可以设计更高效的序列建模算法。
