...
>
> 读本模块时，先抓住“让模型想一想”为什么有用，以及提示式推理、搜索式推理、专门训练的推理模型之间的区别。具体 RL 算法细节可以放到二刷。
...
**读完能看懂的主线**：
- 理解 Chain-of-Thought 及其变体（Zero-shot CoT、Self-Consistency）的原理与使用方法
...
1. Chain-of-Thought 为什么能提升复杂任务表现？它不是“魔法提示词”的地方在哪里？
2. Self-Consistency、Tree-of-Thought、Graph-of-Thought 分别在扩展 CoT 的哪个方向？
3. 推理模型和普通聊天模型在训练目标、推理时间和能力边界上有什么不同？
4. Test-time Compute Scaling 为什么说明“推理时多花计算”也能换能力？
5. 哪些推理方法适合普通应用，哪些更适合数学、代码、规划等复杂任务？
