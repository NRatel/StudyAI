...
> 本文件汇总"Agent 与工具使用"模块的关键论文、常见误区与延伸资源。
>
> **内容时效**：截至 2026 年 4 月
...
**与工程实践的关系**：Reflexion 的思路在 2024-2025 年被广泛应用于编程 Agent（如 Devin 风格的编码 Agent），Agent 在代码执行失败后反思错误并修正。
...
从零构建 Agent 的完整教程，覆盖状态管理、工具使用、Human-in-the-Loop、多 Agent 编排。代码示例丰富，适合动手学习。
